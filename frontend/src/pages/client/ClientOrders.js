...
import { ShoppingCart, Plus, Eye, Clock, Package, Weight, Calendar, MapPin, User, Mail } from 'lucide-react';
...
const ClientOrders = () => {
  ...
  const handleCreateOrder = async (e) => {
    ...
    try {
      // Note: Le client_id sera automatiquement ajouté par le backend
      await api.post('/orders/create-client', createFormData);
